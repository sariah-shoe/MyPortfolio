...
export default function Experiences() {
    ...
    // It is memoized so that I don't constantly rerender when I don't need to
    const profSkills = useMemo(() => {
        return Array.from(
            new Set(
                allExperiences
                    .filter((exp) => exp.typeEx === "Professional" || "Education")
    ...
    const personalSkills = useMemo(() => {
        return Array.from(
            new Set(
                allExperiences
                    .filter((exp) => exp.typeEx === "Personal")
                    .flatMap((exp) => exp.skills)
            )
        ).sort();
    }, [allExperiences]);
                                ...
                                .map(experience =>
                                    ...
                                    >
                                        <span className="inline-block rounded-sm bg-blue-600 p-2 text-white">
                                            ...
                                            {experience.typeEx === "Professional" ? (
                                                <>
                                                    ...
                                                    <p className='sr-only'>Professional Experience</p>
                                                </>
                                                ...
                                                <>
                                                    ...
                                                    <p className='sr-only'>Educational Experience</p>
                                                </>
                                            ) : (
                                                <>
                                                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <p className='sr-only'>Personal Experience</p>
                                                </>
                                            )}
                                        </span>
                                        ...
                                        <div className="mt-4 flex flex-wrap gap-1">
                                            {experience.skills.length > 0 ? experience.skills.map((skill: string) =>
                                            (<span
